...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-ocean-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-teal-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 border border-cyan-500/20 space-y-6">
                <div>
